      ...
      <div className="container mx-auto px-4 pt-20 sm:pt-24 pb-12 sm:pb-16 text-center relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-10 mt-10">
            <img src={nswingLogo} alt="NSWING" className="h-10 opacity-60 hover:opacity-90 transition-opacity invert" />
            <img src={tallowLogo} alt="Tallow" className="h-10 opacity-60 hover:opacity-90 transition-opacity" />
          </div>
        </motion.div>
